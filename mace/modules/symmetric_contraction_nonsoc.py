###########################################################################################
# Non-spin-orbit-coupled symmetric contraction (ported from the magnetic-fix-nonSOC branch
# onto magnetic-pr). Kept in a separate module with its own ALPHABET constants so it cannot
# collide with the (12-letter) ALPHABET used by mace.modules.symmetric_contraction.
###########################################################################################
